  ...
  const features = [
    {
      ...
      description:
        "Imagine turning any asset, from commodities to your own car, into Lego bricks you can easily trade and share on a secure digital marketplace.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Tailored Solutions for Tailored Problems
        </h4>
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p className=" max-w-5xl mx-auto text-left tracking-tight text-xl md:text-2xl md:leading-snug" style={{ color: "#ddbc91" }}>
      {children}
    </p>
  );
};
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          ...
          <img
            src="/images/fireship.jpg"  // Updated path
            alt="header"
            width={800}
            height={800}
...
export const SkeletonTwo = () => {
  const images = [
    ...
    "/vaas4.png",
    "/vaas5.png",
    "/vaas2.png",  // Image paths in public folder
  ];
